...
public class UserService {
    ...
    public void validateRegistration(User user, String password, String passwordConfirmation) throws ValidationException {
        ...
        if (!password.equals(passwordConfirmation)) {
            throw new ValidationException("The password and the confirmation password do not match");
        }
    }
    ...
    public void validateEnter(String login, String password) throws ValidationException {
        User user = userRepository.findByLoginOrEmailAndPassword(login, getPasswordSha(password));
        if (user == null) {
    ...
    public User findByLoginOrEmailAndPassword(String loginOrEmail, String password) {
        return userRepository.findByLoginOrEmailAndPassword(loginOrEmail, getPasswordSha(password));
    }
