...
public class Emphasis implements Element {
    List<Element> elements = new ArrayList<>(); // :NOTE: private final. :NOTE: no initialization
    ...
    @Override
    public void toMarkdown(StringBuilder result) { // :NOTE: Копипаста, вынести в абстрактный класс
        result.append("*");
